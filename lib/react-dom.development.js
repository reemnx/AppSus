...
// reply the begin phase of a failed component inside invokeGuardedCallback.
var replyFailedUnitOfWorkWithInvokeGuardedCallback = true;
...
if (true && replyFailedUnitOfWorkWithInvokeGuardedCallback) {
  var dummyFiber = null;
  beginWork$$1 = function (current$$1, unitOfWork, expirationTime) {
    // If a component throws an error, we reply it again in a synchronously
    ...
    try {
      ...
      if (originalError !== null && typeof originalError === 'object' && typeof originalError.then === 'function') {
        // Don't reply promises. Treat everything else like an error.
        throw originalError;
      }
      ...
      if (hasCaughtError()) {
        var replyError = clearCaughtError();
...
// Used for stashing WIP properties to reply failed work in DEV.
